 ...
 *   bun scripts/package.ts --outfile bitk-app-v0.0.6.tar.gz
 */
...
const defaultOutfile =
  version !== 'dev' ? `bitk-app-v${version}.tar.gz` : 'bitk-app.tar.gz'
...
const archiveName = outfile.split('/').pop() ?? 'bitk-app.tar.gz'
